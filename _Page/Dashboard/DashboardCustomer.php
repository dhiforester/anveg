<?php
    $tahun_ini=date('Y');
    //Akses Customer
    $JumlahAktivitas = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE id_akses='$SessionIdAkses'"));
    //API Key
    $JumlahSurvey = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM survey WHERE id_akses='$SessionIdAkses'"));
    //File
    $JumlahJenisVegetasi = mysqli_num_rows(mysqli_query($Conn, "SELECT DISTINCT nama_ilmiah FROM jenis_vegetasi WHERE id_akses='$SessionIdAkses'"));
    //Dataset
    $JumlahDataset = mysqli_num_rows(mysqli_query($Conn, "SELECT * FROM survey_rincian WHERE id_akses='$SessionIdAkses'"));
?>
                                    ...
                                    series: [{
                                        ...
                                        data: [
                                                    <?php
                                                        ...
                                                        //Hitung jumlah log
                                                        $JumlahLog1 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu1%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog2 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu2%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog3 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu3%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog4 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu4%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog5 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu5%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog6 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu6%' AND id_akses='$SessionIdAkses'"));
                                                        $JumlahLog7 = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM log WHERE tanggal like '%$LabelMinggu7%' AND id_akses='$SessionIdAkses'"));
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="index.php?Page=SurveyCustomer">Lihat Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
